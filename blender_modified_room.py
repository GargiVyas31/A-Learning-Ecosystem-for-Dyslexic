...
path = "/media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/models-OBJ/models/"
path2 = "/media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/Models/"
...
# ROOM PLACEMENT
#room_path = '/media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/room00.obj'
...
for i in data1:
	...
	if line2[1] == 'right':
		...
		print('\n\n\n\n\n\n\n')
		path1 = "/media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/models-OBJ/models/"
		# path2 = "/Volumes/My Passport/SHAPE/Models/Volumes/My Passport/SHAPE/Models/"
		if id1 not in combined_models:
			print(os.system("cd " + path1 + '\n' + 'copy ' + model_id + ' /media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/Models'))
			print(os.system("cd " + path1 + '\n' + 'copy ' + mtl_id + ' /media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/Models'))
			# os.system("cd " + path1 + '\n' + 'open ' + model_id + '.obj')
		else:
		...
		if id1 not in placed_models:
			...
			#width=bpy.context.active_object.dimensions[1]
		...
		if id2 not in placed_models:
			...
			obj_object.location=(placed_models[id1][0],x,placed_models[id1][2])
			placed_models[id2] = (placed_models[id1][0],x,placed_models[id1][2])'''
		...
		path1 = "/media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/models-OBJ/models/"
		if id1 not in combined_models:
			print(os.system("cd " + path1 + '\n' + 'copy ' + model_id + ' /media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/models-OBJ/models'))
			print(os.system("cd " + path1 + '\n' + 'copy ' + mtl_id + ' /media/gargi/FreeAgent GoFlex Drive/Text_to_scene_generation-master/Text_to_scene_generation-master/models-OBJ/models'))
			# os.system("cd " + path1 + '\n' + 'open ' + model_id + '.obj')
		else:
			print("\n\n\n\nPATH CHANGED\n\n\n\n")
			model_path = path2 + model_id
		...
		if id2 not in placed_models:
			...
			#obj_object = bpy.data.objects[id2]
			#obj_object.location=(placed_models[id1][0],-x,placed_models[id1][2])
			#placed_models[id2] = (-x,placed_models[id1][2],placed_models[id1][0])
